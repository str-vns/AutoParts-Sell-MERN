    ...
    <Fragment>
      <header className="bg-white border-2 border-b-black">
        <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
          <Link to="/ProductList" className="inline-block text-teal-600">
              ...
              >
                <div className="p-2" onClick={closeDropdown}>
                  ...
                  {user && user.role === 'admin' && (
                                <Link className="block rounded-lg px-4 py-2 text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-700" to="/Dashboard">Dashboard</Link>
                            )}
                  <Link
